              ...
              <div class="card-body py-3" bis_skin_checked="1">
                ...
                <div class="table-responsive" style="max-height:270px">
                  ...
                  <table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
                    ...
                    <tbody> <?php
$query = $db->prepare("SELECT * FROM yurtici WHERE ekleyen = '$kul_id' ORDER BY id DESC;");
$query->execute();
...
<?php
  ...
  ?>
<input hidden id="metinAlani_<?php echo $sonuc['id']; ?>" value="https://<?php echo ($sonuc2["dom_yurtici"]); ?>/gonderi-Takip?id=<?php echo ($sonuc["id"]); ?>">
...
<span style="margin-right: 5px;"></span>
<a href="https://<?php echo ($sonuc2["dom_yurtici"]); ?>/gonderi-Takip?id=<?php echo ($sonuc["id"]); ?>" target="_blank" data-id="<?php echo $sonuc['id']; ?>" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary w-30px h-30px">
